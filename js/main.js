(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var map = L.map('mapa').setView([-34.49638, -58.485616], 16);

        L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
            attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
        }).addTo(map);

        L.marker([-34.49638, -58.485616]).addTo(map)
        ...
        if (document.getElementById('calcular')) {
            ...
            function validarMail() {
                if (this.value.indexOf("@") > -1) {
                    ...
                    erroDiv.style.display = 'block';
                    erroDiv.innerHTML = "Debe tener al menos una @";
                    this.style.border = '1px solid red';
                    erroDiv.style.border = '1px solid red';
                }
            }
...
$(function() {
    ...
    $('.cuenta-regresiva').countdown('2020/12/12 09:00:00', function(event) {
